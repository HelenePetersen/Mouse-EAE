...
```{r}
ggplot(data = res_all[[1]],
       mapping = aes(x = log2FoldChange,
                     y = -log10(pvalue))) + 
  geom_point() + 
  geom_point(data = res_all[[2]],
             mapping = aes(x = log2FoldChange,
                     y = -log10(pvalue)),
             color = "red") + 
   geom_text_repel()
...
Two genes are found to be significantly downregulated for responders vs. non-responders.
