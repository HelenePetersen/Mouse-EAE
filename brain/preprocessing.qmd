...
sample(seu_obj_filtered@meta.data)
```
...
The intra- and inter-sample doublet are removed from the final filtered data set. The HTO assay will not be included. 

```{r}
seu_obj_filtered2 <- subset(seu_obj_filtered2,
